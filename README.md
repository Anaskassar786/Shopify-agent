...
|---|---|---|
| Types | `pnpm -r run typecheck` | TS strict, zero errors (14 projects) |
| Tests | `pnpm -r run test` | all suites green = 597 |
...
- ◻ M5 Billing + Growth Engine — next

Migrations: `packages/db/drizzle` (0000 core · 0001 shopify core · 0002 RLS · 0003 data plane · 0004 notifications+onboarding · 0005 AI engine).
