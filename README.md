...
| Tests | `pnpm -r run test` | all suites green = 1032 passed + 4 Redis-gated skips (16 projects) |
...
- ◻ M8+ Phase 3–5 — next (AI Copilot, multi-agent expansion, enterprise reporting, public API)
