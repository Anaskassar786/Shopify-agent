...
const envSchema = z
  .object({
    ...
    // ADR 39: Shopify webhook HMAC verifies against SHOPIFY_API_SECRET — the
    // PRD's generic WEBHOOK_SECRET was dead config and is removed (one HMAC
    // source of truth, nothing unused left to drift).
